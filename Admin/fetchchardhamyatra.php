...
<title>Janak Travels Admin Panel - Chardham Yatra Booking</title>
<style>
...
<div class="container">
    ...
    <!-- Main Content Area -->
    <div class="content">
        <!-- View Chardham Yatra Bookings Section -->
        <div class="view-container">
            <h2>View Chardham Yatra Bookings</h2>
            <?php
            ...
            // SQL query to select all rows from the chardhamyatra table
            $sql = "SELECT * FROM chardhamyatra";
