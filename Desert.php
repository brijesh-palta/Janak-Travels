...
<head>
    ...
    <title>Desert Safari Package - Janak Travels</title>
        ...
        <div class="booking-wrapper">
            <div class="booking-form">
                <div class="package-details">
                    <img src="Desert.jpg" alt="Desert Safari">
                </div>
            </div>
        </div>
        <div class="content-wrapper">
            <h1>Desert Safari Package</h1>
            <h2>Desert Safari Package</h2>
            <form id="bookingForm" action="includes/desert_bookings.php" method="post">
