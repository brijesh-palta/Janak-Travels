...
<head>
    ...
    <title>Historical Tour Package - Janak Travels</title>
        ...
        <div class="booking-wrapper">
            <div class="booking-form">
                <div class="package-details">
                    <img src="Historical.jpg" alt="Historical Tour">
                </div>
            </div>
        </div>
        <div class="content-wrapper">
            <h1>Historical Tour Package</h1>
            <h2>Historical Tour</h2>
            <form id="bookingForm" action="includes/Historical.php" method="post">
