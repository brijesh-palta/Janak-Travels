...
<head>
    ...
    <title>Char Dham Yatra Package - Janak Travels</title>
    <link rel="stylesheet" type="text/css" href="Chardhamyatra.css">
    <style>
        body {
        ...
        <div class="booking-wrapper">
            <div class="booking-form">
                <div class="package-details">
                    <img src="kedarnath.jpg" alt="Char Dham Yatra">
                </div>
            </div>
        </div>
        <div class="content-wrapper">
            <h1>Char Dham Yatra Package</h1>
            <h2>Char Dham Yatra Package</h2>
            <form id="bookingForm" action="includes/chardhamyatra.php" method="post">
...
</html>Desert Safari Package - Janak Travels