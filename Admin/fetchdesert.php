...
<title>Janak Travels Admin Panel - Desert Booking</title>
<style>
...
<div class="container">
    ...
    <!-- Main Content Area -->
    <div class="content">
        <!-- View Desert Bookings Section -->
        <div class="view-container">
            <h2>View Desert Bookings</h2>
            <?php
            ...
            // SQL query to select all rows from the desert_bookings table
            $sql = "SELECT * FROM desert_bookings";
