...
<title>Janak Travels Admin Panel - Beach Booking</title>
<style>
...
<div class="container">
    ...
    <!-- Main Content Area -->
    <div class="content">
        <!-- View Beach Bookings Section -->
        <div class="view-container">
            <h2>View Beach Bookings</h2>
            <?php
            ...
            // SQL query to select all rows from the beach_bookings table
            $sql = "SELECT * FROM beach_bookings";
