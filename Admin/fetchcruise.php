...
<title>Janak Travels Admin Panel - Cruise Booking</title>
<style>
...
<div class="container">
    ...
    <!-- Main Content Area -->
    <div class="content">
        <!-- View Cruise Bookings Section -->
        <div class="view-container">
            <h2>View Cruise Bookings</h2>
            <?php
            ...
            // SQL query to select all rows from the cruisebooking table
            $sql = "SELECT * FROM cruisebooking";
