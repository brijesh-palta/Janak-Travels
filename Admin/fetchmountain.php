...
<title>Janak Travels Admin Panel - Mountain Booking</title>
<style>
...
<div class="container">
    ...
    <!-- Main Content Area -->
    <div class="content">
        <!-- View Mountain Bookings Section -->
        <div class="view-container">
            <h2>View Mountain Bookings</h2>
            <?php
            ...
            // SQL query to select all rows from the mountain_bookings table
            $sql = "SELECT * FROM mountain_bookings";
