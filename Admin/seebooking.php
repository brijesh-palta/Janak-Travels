                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        for (var i = 0; i < bookingData.length; i++) {
                            var row = $('<tr></tr>');
                            row.append('<td>' + bookingData[i].id + '</td>');
                            row.append('<td>' + bookingData[i].name + '</td>');
                            row.append('<td>' + bookingData[i].mobile + '</td>');
                            row.append('<td>' + bookingData[i].email + '</td>');
                            row.append('<td>' + bookingData[i].type_of_car + '</td>');
                            row.append('<td>' + bookingData[i].origin + '</td>');
                            row.append('<td>' + bookingData[i].destination + '</td>');
                            row.append('<td>' + bookingData[i].date_from + '</td>');
                            row.append('<td>' + bookingData[i].date_to + '</td>');
